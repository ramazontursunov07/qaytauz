    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, max_length=13, null=True, validators=[django.core.validators.RegexValidator(message="Telefon raqamni to'g'ri formatda kiriting:+998xxxxxxxxx ", regex='^\\+998\\d{9}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notification_type', models.CharField(choices=[('Yangi xabar', 'Yangi xabar'), ("E'lon yoqtirildi", "E'lon yoqtirildi"), ('Yangi sharh', 'Yangi sharh'), ('Moderatsiya natijasi', 'Moderatsiya natijasi'), ('Aksiya/chegirma', 'Aksiya/chegirma')], max_length=20)),
